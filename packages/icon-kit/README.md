...
```sh
$ npm install @allincart-ag/meteor-icon-kit
```

Or if you prefer using Yarn:

```sh
$ yarn add @allincart-ag/meteor-icon-kit
```
...
```scss
@import "@allincart-ag/meteor-icon-kit/icons/meteor-icon-kit.scss";
```
...
```js
import wallet from "@allincart-ag/meteor-icon-kit/icons/regular/wallet.svg";
```
...
<script setup>
import ActivityIcon from "@allincart-ag/meteor-icon-kit/icons/regular/activity.svg";
</script>
```
