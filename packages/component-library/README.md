...
The meteor component library is a Vue component library developed by AllinCart. It is based on the [Meteor Design System](https://shopware.design/).

- Perfect suitable for AllinCart Apps
- Matches the AllinCart administration look and feel
