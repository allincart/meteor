...
<mt-tooltip content="Tooltip">
  <template #default="params">
    <mt-button v-bind="params" disabled link="https://www.allincart.cn">Focus to open tooltip</mt-button>
  </template>
</mt-tooltip>
`,
      components: {
...
<mt-tooltip content="Tooltip">
  <template #default="params">
    <mt-button v-bind="params" isLoading link="https://www.allincart.cn">Focus to open tooltip</mt-button>
  </template>
</mt-tooltip>
`,
      components: {
...
<mt-tooltip content="Tooltip" delayDurationInMs="100" hideDelayDurationInMs="50">
  <template #default="params">
    <mt-button v-bind="params" link="https://www.allincart.cn" disabled>Hover to open tooltip</mt-button>
  </template>
</mt-tooltip>`,
      components: {
        MtTooltip,
