...
$color-allin-cart-brand-vivacious-500: #0f76de;
  ...
  */
  ...
  .mt-data-table__table-head-dropzone-before {
    ...
    box-shadow: inset $dropzone-highlight-width 0px $dropzone-highlight-width
      $dropzone-highlight-negative-width $color-allin-cart-brand-900;
  }
  ...
  */
  ...
  .mt-data-table__table-context-button {
    ...
    a {
      position: relative;
      top: 1px;
      color: $color-allin-cart-brand-vivacious-500;
...
.mt-data-table__table-head-dragzone-bar {
  ...
  background-color: $color-allin-cart-brand-900;
  border-radius: var(--border-radius-xs) var(--border-radius-xs) 0 0;
